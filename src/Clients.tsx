...
export default function ClientsPage() {
  ...
  return (
    <AppShell
      activeNav="clients"
      title={selectedClientName ? `Dashboard: ${selectedClientName}` : "Clients Directory"}
      ...
      <AnimatePresence mode="wait">
        {selectedClientName ? (
          ...
          <motion.div
            ...
            exit={{ opacity: 0, x: 15 }}
            transition={{ duration: 0.3 }}
            className="relative z-10 px-8 pt-6 pb-8 w-full min-h-full flex flex-col"
          >
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-right">
                          <button
                            ...
                            onClick={(e) => { e.stopPropagation(); setSelectedClientName(client.name); }}
                          >
                            <ArrowRight size={18} />
                          </button>
                        </td>
